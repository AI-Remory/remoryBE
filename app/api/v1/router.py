...
from app.api.v1.endpoints import auth, chat, deletion, group, interview, media, persona, photo_memory, sharing, storybook, target, consent, verification, admin, report, realtime_voice
...
api_v1_router.include_router(realtime_voice.router)
